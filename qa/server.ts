...
Hacélo en formato Markdown claro con títulos descriptivos.`;
    ...
    const response = await ai.models.generateContent({
      ...
      contents: prompt,
      config: {
        systemInstruction: "Sos el asistente oficial de Mudanzas Mendoza 2026. Tu personalidad es muy cercana, confiable, mendocina de pura cepa, súper servicial y cero formal-corporativa. Tu objetivo es calmar los nervios del cliente y darle tips de oro."
      }
    });
