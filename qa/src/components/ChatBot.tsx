    ...
    <div className="fixed bottom-6 right-6 z-50 font-sans">
      ...
      {!isOpen && (
        <button
          ...
          className="flex items-center gap-2.5 bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold p-4 sm:px-5 sm:py-4 rounded-full shadow-2xl hover:scale-105 active:scale-95 transition-all cursor-pointer group"
        >
      ...
      {isOpen && (
        <div className="w-[360px] sm:w-[400px] h-[540px] bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl overflow-hidden flex flex-col animate-fade-in text-slate-100">
          {/* Header */}
