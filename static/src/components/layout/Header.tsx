...
export default function Header({
  ...
  // Refactor scroll-to-section logic to avoid repetition, prevent crashes, and improve clarity
  const handleScrollToSection = useCallback(
    (e: React.MouseEvent, sectionId: string) => {
      ...
      if (activePage !== "") {
        ...
        }, 300); // 300ms is safer for page mount
      } else {
        const element = document.getElementById(sectionId);
        if (element) {
          element.scrollIntoView({ behavior: "smooth" });
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-1">
            ...
            <button
              ...
              className="px-4 py-2 rounded-xl text-sm font-semibold text-slate-600 hover:text-slate-900 hover:bg-slate-100/60 transition-all cursor-pointer"
            >
              Preguntas
            </button>
            <button
          ...
          <div className="hidden lg:flex items-center gap-3">
            <button
              onClick={(e) => handleScrollToSection(e, "form")}
          ...
          <div className="flex lg:hidden items-center gap-3">
            <a
              ...
              className="bg-amber-500 hover:bg-amber-600 text-white p-3 rounded-xl shadow-md cursor-pointer text-xs font-semibold flex items-center justify-center"
      ...
      {/* Mobile Drawer Navigation with Framer Motion and Dynamic Offset */}
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
