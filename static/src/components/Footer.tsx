      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        <div className="space-y-4">
          ...
          <div className="space-y-3 pt-2 text-sm">
            <div className="footer-contact-item">
              ...
              <a href="https://maps.google.com/?q=Armada+Argentina+584,+Mendoza,+Argentina" target="_blank" rel="noopener noreferrer" className="footer-link-hover">
                Armada Argentina 584, Mendoza, AR
              </a>
            </div>
            <div className="footer-contact-item">
              <Phone className="footer-icon-amber" />
              <a href="tel:+5492615130910" className="footer-link-hover font-medium text-slate-700">
                +54 9 261 513-0910
              </a>
            </div>
            <div className="footer-contact-item">
              <Mail className="footer-icon-amber" />
              <a href="mailto:info@mudanzasmendoza.com.ar" className="footer-link-hover">
        ...
        <div className="space-y-4">
          ...
          <p className="footer-text-sm-light font-medium">
            ¿Listo para tu próxima mudanza? Consultanos dentro de nuestros horarios:
          </p>
          <div className="space-y-3 text-sm">
            <div className="footer-contact-item">
              ...
              <div>
                ...
                <p className="footer-text-xs-light">08:00 - 20:00 (Continuado)</p>
              </div>
            </div>
            <div className="footer-contact-item">
            ...
            <div className="footer-contact-item">
              ...
              <div>
                ...
                <p className="footer-text-xs-light">Cerrado (Atención de Emergencias)</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2 footer-nav-link-text">
            <li>
              <button onClick={() => handleLinkClick("mudanzas-urgentes")} className="footer-nav-link footer-link-hover">
                Mudanzas Urgentes ⚡
              </button>
            </li>
            <li>
              <button onClick={() => handleLinkClick("mudanzas-24-horas")} className="footer-nav-link footer-link-hover">
                Mudanzas 24 Horas 🕒
              </button>
            </li>
            <li>
              <button onClick={() => handleLinkClick("mudanzas-residenciales")} className="footer-nav-link footer-link-hover">
                Mudanzas Residenciales
              </button>
            </li>
            <li>
              <button onClick={() => handleLinkClick("blog")} className="footer-nav-link footer-link-hover">
                Blog de Mudanzas & Consejos
              </button>
            </li>
            <li>
              <a href="/mudanzas-en-mendoza.html" className="footer-nav-link footer-link-hover">
        ...
        <div className="space-y-4">
          <h4 className="footer-section-title font-sans">Destinos Frecuentes</h4>
      ...
      <div className="footer-bottom-container">
        <div className="footer-bottom-inner">
          ...
          <div className="footer-social-links-container">
            <a href="https://www.instagram.com/mudanzasmiranda/" target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="Instagram de Mudanzas Miranda">
              <Instagram className="footer-social-icon" />
            </a>
            <a href="https://www.facebook.com/mudanzasmiranda4" target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="Facebook de Mudanzas Miranda">
